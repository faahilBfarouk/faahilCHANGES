        ...
        <div class="tp-banner" >
            <ul>                        
                <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" 
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="<?= base_url("Themes/cars/dark/") ?>img/slides/home2.jpg"  alt="2" data-lazyload="<?= base_url("Themes/cars/dark/") ?>img/slides/home2.jpg" 
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" 
                    data-saveperformance="on"  data-title="Ken Burns Slide">
                    <!-- MAIN IMAGE -->
                    <img src="<?= base_url("Themes/cars/dark/") ?>img/slides/home1.jpg"  alt="2" data-lazyload="<?= base_url("Themes/cars/dark/") ?>img/slides/home1.jpg" 
                         data-bgposition="right top" data-kenburns="off" data-duration="12000" 
                         data-ease="Power0.easeInOut" data-bgfit="115" data-bgfitend="100" 
                         data-bgpositionend="center bottom"> 
                    <div class="tp-caption tentered_white_huge lft tp-resizeme" 
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" 
                    data-saveperformance="on"  data-title="Ken Burns Slide">
                    <!-- MAIN IMAGE -->
                    <img src="<?= base_url("Themes/cars/dark/") ?>img/slides/home3.jpg"  alt="2" data-lazyload="<?= base_url("Themes/cars/dark/") ?>img/slides/home3.jpg" 
                         data-bgposition="right top" data-kenburns="off" data-duration="12000" 
                         data-ease="Power0.easeInOut" data-bgfit="115" data-bgfitend="100" 
                         data-bgpositionend="center bottom"> 
                    <div class="tp-caption tentered_white_huge lft tp-resizeme" 
...
<section class="block">
                ...
                <div class="agents-carousal-sec">
                    ...
                    <li>
                        <div class="agent-content">
                                ...
                                <p>For Personalised Care And Sincere Help<br>Or Our Top Agent Here! <br><br><a href="<?= base_url("Home/Contact") ?>" title="" class="flat-btn">Contact us</a></p>
    ...
    <p>                <i class="fa fa-phone" aria-hidden="true"></i> <?=$agent[0]['Emp_mobile'] ?>
                   <br> <i class="fa fa-envelope" aria-hidden="true"></i> <?=$agent[0]['Emp_email'] ?>
                        ...
                        <li>
                        <div class="agent-content">
                                <h3>Want To Renew Your Insurance?</h3>
                                <p><a href="<?= base_url("Home/Contact") ?>" title="" >Fill Form Here</a><br> More Queries? Check Out Maruthi Insurance's <br><br><a href="https://www.marutiinsurance.com/FAQS.aspx" title="" class="flat-btn">FAQ</a></p>
